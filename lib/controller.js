  ...
  this.node.arguments.forEach((argument) => {
    ...
    argument.properties.forEach((property) => {
      ...
      if (property.value.type === 'CallExpression' && property.value.callee.type === 'MemberExpression') {
        ...
        if ((callee.object.name === 'Ember' && callee.property.name === type ) || (callee.property.name === 'and') || (callee.property.name === 'or') || (callee.property.name === 'alias') || (callee.property.name === 'not')){
